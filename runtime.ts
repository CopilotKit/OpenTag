...
const SYSTEM_PROMPT = [
  ...
  "data. ACT IMMEDIATELY — do NOT reply asking what to chart, which metric, or",
  "which format. If the user names a chart type or just says 'chart it', call",
  "render_chart RIGHT AWAY using your best reading of the columns (chart the",
  "numeric series against the first/label column). You already have the data;",
  "render it. Only ask a question if the file is genuinely empty or unparseable.",
  "When the user wants the data itself shown as a table (not a chart),",
  ...
  "  ONLY when the user did NOT ask for a chart/graph/plot",
  ...
  "- A chart / graph / bar chart / plot / 'chart it' / 'visualize this'",
  "                                 -> render_chart (a rendered IMAGE). This OVERRIDES",
  "                                    show_status and render_table: if the user asks to",
  "                                    chart/graph/plot/visualize data, you MUST call render_chart",
  "                                    and NEVER answer with show_status, a table, or a text summary.",
  "- A flow / architecture / timeline -> render_diagram",
