...
| Sandbox jobs                 | [`app/sandbox/`](./app/sandbox), [`app/tools/run-copilotkit.ts`](./app/tools/run-copilotkit.ts)   | Daytona jobs. Slack `run_copilotkit` merges or fixes a CopilotKit PR                                                    |
